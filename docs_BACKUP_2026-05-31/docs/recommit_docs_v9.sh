...
# V9: Field-level data flow analysis (writers/readers/work fields)
#
# WHAT'S NEW IN V9:
...
#   recommit_docs_v9.sh                       — This script
#
# Run from: ~/Meshtastic-Android
# Usage:    bash docs/recommit_docs_v9.sh
...
# TEXTOUT removed in v9 — all output goes to $DOCS

CROSSREF="$DOCS/field_crossref_raw.txt"

echo "=== GROUPTRACK DOCS RECOMMIT v9 ==="
echo ""
...
================================================================================
Auto-generated by recommit_docs_v9.sh
...
# Copy this script
cp "$DOWNLOADS/recommit_docs_v9.sh" "$DOCS/recommit_docs_v9.sh" 2>/dev/null
