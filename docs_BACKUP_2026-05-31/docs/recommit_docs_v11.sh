...
# Usage:    bash docs/recommit_docs_v11.sh
...
# Copy this script
cp "$DOWNLOADS/recommit_docs_v11.sh" "$DOCS/recommit_docs_v11.sh" 2>/dev/null
...
================================================================================
Auto-generated by recommit_docs_v11.sh
