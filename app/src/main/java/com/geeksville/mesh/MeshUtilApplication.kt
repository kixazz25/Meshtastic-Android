...
open class MeshUtilApplication :
    ...
    override fun onCreate() {
        ...
        // INITREVERT-2026-09-14: a map-source load call sat here and was removed.
        // It changed WHEN startup work happens, and location stopped resolving in
        // the same build. The source-loading fix lives in ensureInit() over in
        // MapSourceManager instead, where it changes WHAT happens and not WHEN.
        // Do not re-add a load here without first establishing what else in
        // onCreate depends on running before it.
