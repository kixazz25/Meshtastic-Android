#!/usr/bin/env python3
"""
nav_pass6_panguitch_2026-08-22.py
...
OUT = r"D:\nav_test\out"
SET_NAME = "Panguitch"         # free loop from the town park on Main St

# Panguitch town park, Main St -- start and end here.
# Second corridor, and a real test of whether the scoring generalises: the
# Arizona Strip was 22 springs of 39 features, heavily BLM, 77% unnamed track.
# Panguitch sits by Dixie NF and Bryce, so expect more Forest Service ground
# and a different feature mix. If the weights only worked on the Strip, this
# is where that shows.
BAR10 = (37.8222, -112.4358)
...
SPEED_MPH = (12.0, 18.0)
LAT_S, LAT_N, LON_W, LON_E = 37.55, 38.10, -112.85, -112.05
...
def main():
    ...
    cur = con.cursor()
    print("="*78)
    print("PASS 6 -- FREE LOOP FROM PANGUITCH   %s   explore to %.0f mi"
