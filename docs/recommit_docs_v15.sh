...
# Usage:    bash docs/recommit_docs_v15.sh
...
cp "$DOWNLOADS/recommit_docs_v15.sh" "$DOCS/recommit_docs_v15.sh" 2>/dev/null
...
echo "================================================================="
echo "Auto-generated by recommit_docs_v15.sh"
...
echo ""
echo "================================================================="
echo "RECOMMIT V15 COMPLETE -- $(date '+%Y-%m-%d %H:%M')"
echo "================================================================="
