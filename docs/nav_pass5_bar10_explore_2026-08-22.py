#!/usr/bin/env python3
"""
nav_pass5_bar10_explore_2026-08-22.py
...
OUT = r"D:\nav_test\out"
SET_NAME = "Bar 10 Explore"    # free loop -- no fixed destination

BAR10 = (36.43, -113.35)
# NO fixed destination. The Toroweap run spent 53.7 of every 80 miles on the
# tether out and back, leaving ~26 for features and forcing 50% retrace.
# This is the same machinery with that constraint removed: start at Bar 10,
# wander, come back. Whether the freedom is worth more than the destination
# is the question the two runs answer between them.
...
def main():
    ...
    cur = con.cursor()
    print("="*78)
    print("PASS 5 -- FREE LOOP FROM BAR 10   %s   explore to %.0f mi"
