...
object ConvoyRoutes {
    ...
    @Serializable data object ConvoyInviteSend        : Route  // V3 Phase B
    @Serializable data object ConvoyBroadcast         : Route  // V3 Phase B
    ...
    @Serializable data object ConvoyTrackImport      : Route  // V2.4 Import tracks from Downloads
