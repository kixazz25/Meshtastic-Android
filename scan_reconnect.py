...
lines = open('/c/Users/kixaz/Meshtastic-Android/app/src/main/java/com/geeksville/mesh/convoy/ConvoyReconnectWaitScreen.kt', 'r', encoding='utf-8').readlines()
